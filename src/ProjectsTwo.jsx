    ...
    >
      <div className="container px-4 mx-auto">
        <div className="mb-8 md:mb-16 md:max-w-5xl">
          <span className="inline-block py-px px-2 mb-4 text-xs leading-5 text-violet-500 bg-violet-100 font-medium uppercase rounded-full shadow-sm">Blog</span>
        ...
        <ul className="flex flex-wrap mb-8 -mx-2 text-center">
          <li className="w-full md:w-auto px-2">
            <a className="inline-block w-full py-2 px-4 mb-4 md:mb-0 text-sm text-coolGray-400 hover:text-violet-500 hover:bg-violet-200 font-bold rounded-md hover:shadow-sm" href="#">
              All Categories
            </a>
          </li>
          <li className="w-full md:w-auto px-2">
          ...
          <li className="w-full md:w-auto px-2">
            <a className="inline-block w-full py-2 px-4 text-sm text-coolGray-400 hover:text-violet-500 hover:bg-violet-200 font-bold rounded-md hover:shadow-sm" href="#">
              Start-up
            </a>
          </li>
        </ul>
        <div className="flex flex-wrap items-center -mx-4 mb-12 md:mb-16">
          <div className="flex flex-wrap items-center w-full xl:w-1/2 px-4 mb-8 md:-mx-4">
            ...
            <div className="w-full md:flex-1 md:px-4">
              <a className="inline-block mb-4 text-2xl leading-tight text-coolGray-800 hover:text-coolGray-900 font-bold hover:underline" href="#">
              ...
              <a className="inline-flex items-center text-base md:text-lg text-violet-500 hover:text-violet-600 font-semibold" href="#">
